...
function ValueBox({ label, value, color }: { label: string; value: string | null; color: string }) {
  return (
    <div className={`rounded border ${color} p-3 w-[320px] flex-shrink-0 flex flex-col min-h-0`}>
  ...
  return (
    ...
    >
      <div
        ...
        className={`bg-white rounded-xl shadow-2xl w-full mx-4 h-[36rem] flex flex-col ${hasFileC ? "max-w-[1040px]" : "max-w-[700px]"}`}
