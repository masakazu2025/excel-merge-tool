...
def _cell(sheet, cell, base, b, c=None, *, conflict=False, review=False, hint="replace", typ="value"):
    return {
        "id": f"{sheet}__{cell}",
        "cell": cell,
        "base_value": base,
        ...
        "type": typ,
        "conflict": conflict,
        "review_required": review or conflict,
        "diff_hint": hint,
    }
    ...
    "sheets": {
        S: {
            "cells": [
                ...
                # --- G列: ステータス変更 ---
                _cell(S, "G3",  base="対応中", b="完了",    hint="replace"),
                _cell(S, "G7",  base="対応中", b="レビュー中", hint="replace"),
                _cell(S, "G11", base="調査中",  b="完了",    hint="replace"),
                _cell(S, "G15", base="調査中",  b="完了",    hint="replace"),
                _cell(S, "G17", base="未着手",  b="対応中",  hint="replace"),
                _cell(S, "G21", base="調査中",  b="完了",    hint="replace"),

                # --- D列: 担当者変更 ---
                _cell(S, "D5",  base="田中",  b="田中",   c="佐藤", conflict=True, hint="replace"),
                _cell(S, "D13", base="未定",  b="鈴木",   hint="insert_only"),
                _cell(S, "D19", base="",      b="山田",   hint="new"),
            ],
            "comments": [],
        ...
        "課題管理": {
            "cells": [
                ...
                _cell("課題管理", "C7",
                    ...
                    conflict=True, hint="replace"),
                _cell("課題管理", "D4", base="未着手", b="対応中", hint="replace"),
                _cell("課題管理", "D7", base="未着手", b="未着手", c="対応中", conflict=True, hint="replace"),
            ],
            "comments": [],
            "shapes": {"matched": [], "added_b": [], "added_c": [], "deleted_b": [], "deleted_c": []},
        },
